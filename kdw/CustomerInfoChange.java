...
public class CustomerInfoChange extends JPanel implements ActionListener,ItemListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		//수정버튼을 눌렀을 경우
			...
			if(result == JOptionPane.YES_OPTION) {
				...
				if(r > 0) {
JOptionPane.showMessageDialog(this, "완벽하게 수정되었습니다.");				}else {
