...
public class MyPageInfoChange extends JFrame implements ActionListener,ItemListener{
	...
	public MyPageInfoChange(String str) {
    	super(str);
	...
	public void actionPerformed(ActionEvent e) {
		...
		//수정버튼을 눌렀을 경우
			...
			if(result == JOptionPane.YES_OPTION) {
				...
				JOptionPane.showMessageDialog(this, "작업이 완료되었습니다");

		}
		else if(obj == deleteid) {
			JOptionPane.showMessageDialog(this, "관리자에게 문의하세요. ph. 010-9956-8955");
		}
