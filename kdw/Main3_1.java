...
public class Main3_1 extends JFrame implements ActionListener{
	@Override
	public void actionPerformed(ActionEvent e) {
		...
		if(o == custom) {
			...
			JOptionPane.showMessageDialog(this, ",눌렀네");
