...
public class Movie_Info {
	...
	private String movie_screen;
	private String movie_round;
	private String movie_price;
	private String movie_image;
	private String movie_infos;
	...
	public String getMvvie_genre() {
		return movie_genre;
	}
	public void setMvvie_genre(String mvvie_genre) {
		this.movie_genre = mvvie_genre;
	}
	...
	public String getMovie_round() {
		return movie_round;
	}
	public void setMovie_round(String movie_round) {
	...
	public String getMovie_infos() {
		return movie_infos;
	}
	public void setMovie_infos(String movie_infos) {
		this.movie_infos = movie_infos;
	}
