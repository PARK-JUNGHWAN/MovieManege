...
public class CalendarBoard extends JFrame implements WindowListener, ActionListener, ItemListener{
	...
	public CalendarBoard(ReservationBoardPan1 rbp){
...
//	dms.textField[1].setText(total);
	...
	public void calendar(ReservationBoardPan1 rbp){
